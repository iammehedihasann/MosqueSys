import { AlertTriangle, Bolt, Droplet, Flame, Heart, Phone, Shield } from 'lucide-react'
...
const typeMeta: Record<EmergencyServiceType, { label: string; icon: React.ComponentType<{ className?: string }>; tone: string; badge: 'emergency' | 'general' | 'success' }> = {
...
export function EmergencyContactCard({ contact, detailPath, className }: EmergencyContactCardProps) {
      ...
      <div className="flex items-start gap-4">
        ...
        <div className="flex-1">
          <div className="flex flex-wrap items-center gap-2">
            <h3 className="text-lg font-semibold text-[var(--color-text)]">{contact.nameBn}</h3>
