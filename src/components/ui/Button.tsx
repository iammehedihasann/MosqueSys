...
const variantStyles: Record<ButtonVariant, string> = {
  ...
  secondary:
    "bg-[var(--color-bg)] text-[var(--color-text)] border border-[var(--color-text-muted)] hover:bg-gray-200",
  outline:
...
export const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  ({ variant = "primary", size = "md", asChild, to, children, className, ...props }, ref) => {
    const base =
      "inline-flex items-center justify-center font-medium rounded-[var(--radius-button)] transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:opacity-50";
