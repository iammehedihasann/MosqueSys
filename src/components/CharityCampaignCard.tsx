...
export function CharityCampaignCard({ campaign, detailPath, className }: CharityCampaignCardProps) {
  ...
  return (
    ...
    >
      <div className="flex items-start justify-between gap-3">
        <div>
          <h3 className="text-lg font-semibold text-[var(--color-text)]">{campaign.titleBn}</h3>
          <p className="mt-1 text-sm text-[var(--color-text-muted)]">{campaign.descriptionBn}</p>
        </div>
