...
const toBnDigits = (value: number | string) => {
  ...
  return value.toString().replace(/\d/g, (digit) => map[Number(digit)]);
};
...
export function CharityDetails() {
    ...
    return (
      <div className="min-h-screen bg-bg py-12">
        <div className="mx-auto max-w-3xl px-4 sm:px-6">
          <div className="rounded-3xl border border-border bg-white p-8 text-center shadow-[var(--shadow-section)]">
            <h1 className="text-2xl font-semibold text-text">
              ক্যাম্পেইনের তথ্য পাওয়া যায়নি
            </h1>
  ...
  const heroImage =
    campaign.image && images[imageKey] ? images[imageKey] : campaign.image;
      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col gap-6 lg:flex-row">
            <div className="flex-1">
              ...
              <div className="mt-4 space-y-2 text-sm text-[var(--color-text-muted)]">
                {campaign.beneficiaryBn && (
                  <p>উপকারভোগী: {campaign.beneficiaryBn}</p>
                )}
        ...
        <section className="mt-10 grid gap-8 md:grid-cols-2">
          <div>
            <SectionTitle
              title="কর্মসূচি"
              subtitle="এই ক্যাম্পেইনে যা করা হবে"
            />
          ...
          <div>
            <SectionTitle
              title="সর্বশেষ আপডেট"
              subtitle="ক্যাম্পেইনের অগ্রগতির খবর"
            />
            <ul className="space-y-2 text-sm text-[var(--color-text-muted)]">
        ...
        {galleryImages.length > 0 && (
          <section className="mt-10">
            <SectionTitle
              title="ক্যাম্পেইনের ছবি"
              subtitle="কার্যক্রমের কিছু দৃশ্য"
            />
